node{
    ...
    stage('Publish build-info') {
     try {
        ...
        sh 'curl -v --user ${admin}:${939491122**Gg}  -T build-latest.zip -X PUT "http://18.159.82.82:8082/artifactory/generic-local/bobojon/${NODE_NAME}/jenkinsapp-${MYTOOL_VERSION}.${BUILD_NUMBER}.zip"'
    }
