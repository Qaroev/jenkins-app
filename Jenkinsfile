node{
    ...
    stage('Publish build-info') {
     try {
        ...
        sh 'curl -u admin:AP2A3ijtMQrrF3bBJN9WvVf6jxf -T build-latest.zip  PUT "http://18.159.82.82:8082/artifactory/test-rep/bobojon/${NODE_NAME}/jenkinsapp-${MYTOOL_VERSION}.${BUILD_NUMBER}.zip"'
    }
